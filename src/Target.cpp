...
static ShapeDetectionOptions shapeOptions = {
 ...
 void Target::setthres(int x)
{
	curveOptions.threshold=x;
}
 void Target::setminmatc(double x)
{
	shapeOptions.minMatchScore=x;
}
 void Target::setonlyclos(int x)
{
	curveOptions.onlyClosed=x;
}
 void Target::setsubpix(int x)
{
	curveOptions.subpixelAccuracy=x;
}
 int Target::getthres()
{
	return curveOptions.threshold;
}
 double Target::getminmatc()
{
	return shapeOptions.minMatchScore;
}
 int Target::getonlyclos()
{
	return curveOptions.onlyClosed;
}
 int Target::getsubpix()
{
	return curveOptions.subpixelAccuracy;
}
